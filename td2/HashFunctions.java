...
public class HashFunctions {
	...
	public static void main(String[] args) {
		...
		System.out.println(100 + " est présent: " + e.containsValue(100));
		System.out.println(99 + " est présent: " + e.containsValue(99));
		System.out.println(200 + " est présent: " + e.containsValue(200));
		System.out.println(199 + " est présent: " + e.containsValue(199));
		System.out.println(300 + " est présent: " + e.containsValue(300));
		System.out.println(299 + " est présent: " + e.containsValue(299));
		System.out.println();

		System.out.println(
				"La clé de 100 est : " + e.getKey(100) + ", elle est présente: " + e.containsKey(e.getKey(100)));
		System.out
				.println("La clé de 99 est : " + e.getKey(99) + ", elle est présente: " + e.containsKey(e.getKey(99)));
		System.out.println(
				"La clé de 200 est : " + e.getKey(200) + ", elle est présente: " + e.containsKey(e.getKey(200)));
		System.out.println(
				"La clé de 199 est : " + e.getKey(199) + ", elle est présente: " + e.containsKey(e.getKey(199)));
		System.out.println(
				"La clé de 300 est : " + e.getKey(300) + ", elle est présente: " + e.containsKey(e.getKey(300)));
		System.out.println(
				"La clé de 299 est : " + e.getKey(299) + ", elle est présente: " + e.containsKey(e.getKey(299)));
		System.out.println();
		...
		System.out.println("La clé de 100 est : " + pfhash.getKey(100) + ", elle est présente: "
				+ pfhash.containsKey(pfhash.getKey(100)));
		System.out.println("La clé de 99 est : " + pfhash.getKey(99) + ", elle est présente: "
				+ pfhash.containsKey(pfhash.getKey(99)));
		System.out.println("La clé de 200 est : " + pfhash.getKey(200) + ", elle est présente: "
				+ pfhash.containsKey(pfhash.getKey(200)));
		System.out.println("La clé de 199 est : " + pfhash.getKey(199) + ", elle est présente: "
				+ pfhash.containsKey(pfhash.getKey(199)));
		System.out.println("La clé de 300 est : " + pfhash.getKey(300) + ", elle est présente: "
				+ pfhash.containsKey(pfhash.getKey(300)));
		System.out.println("La clé de 299 est : " + pfhash.getKey(299) + ", elle est présente: "
